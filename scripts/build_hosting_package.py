...
# Archivos de documentación interna que no forman parte de la web pública.
EXCLUDE_SUFFIXES = {".md"}
...
def main():
    ...
    for source in SOURCE.rglob("*"):
        ...
        # El paquete descargable apunta al hosting final sin alterar GitHub Pages.
        content = content.replace(LEGACY_URL, SITE_URL)
        target.write_text(content, encoding="utf-8")

    # Evita que configuraciones heredadas de Pages afecten a otros hostings.
